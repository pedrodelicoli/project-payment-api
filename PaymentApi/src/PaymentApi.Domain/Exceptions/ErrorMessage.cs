namespace PaymentApi.Domain.Exceptions
{
    public static class ErrorMessage
    {
        ...
        public static string errorSellerNameIsRequired = "O campo Nome do Vendedor é obrigatório!";
        ...
        public static string errorItemNameIsRequired = "O campo Nome do Item é obrigatório!";
